...
If you experience bugs or general issues with `jira-notifications`, please have a look
...
You can help improve `jira-notifications` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`jira-notifications` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `jira-notifications`'s files. While this mechanism can
...
```
conda create -n jira-notifications python=3 six virtualenv pytest pytest-cov
conda activate jira-notifications
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/jira-notifications.git
   cd jira-notifications
   ```
...
5. Install [pre-commit]:
   ...
   `jira-notifications` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/jira-notifications
[issue tracker]: https://github.com/<USERNAME>/jira-notifications/issues
